...
This workshop is a 5days paid cloud based program where we design, verify and analyze ASIC focused FPGA, the lectures and lab access is private to individual. 
...
In this course,
1. On day1 we cover, [Introduction to FPGA](https://github.com/pavankumarka/FPGA-Fabric-Design-Architecture-Workshop/blob/main/1_Introduction_To_FPGA_Architecture.md)
2. on day2 we cover, []()
3. on day3 we cover, []()
4. on day4 we cover, []()
5. on day5 we cover, []()

At the end of this workshop we learnt how to design, verify and analyze ASIC focused FPGA.
